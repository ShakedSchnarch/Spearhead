...
- [x] **Robust Data Ingestion** <!-- id: 16 -->
  - [x] Update `FieldMapper.infer_platoon` to ignore suffixes like `(תגובות)`. <!-- id: 16.1 -->
  - [x] Add explicit regex mapping for known units (Kfir, Lahav, etc.). <!-- id: 16.2 -->
