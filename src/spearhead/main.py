...
from spearhead.renderer.builder import ReportBuilder
from spearhead.domain.models import BattalionData
from spearhead.config import settings

app = typer.Typer(help="Spearhead Battalion Readiness System")
...
def version():
    """
    Prints the version of Spearhead.
    """
    print("Spearhead v1.0.0")
...
def build(
    ...
    logger = logging.getLogger("spearhead")
    
    logger.info(f"Starting Spearhead build. Input: {input_path}")
